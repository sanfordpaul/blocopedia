...
RSpec.describe CollaborationsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      collaboration = Collaboration.create! valid_attributes
      get :edit, params: {id: collaboration.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the collaboration" do
        collaboration = Collaboration.create! valid_attributes
        put :update, params: {id: collaboration.to_param, collaboration: valid_attributes}, session: valid_session
